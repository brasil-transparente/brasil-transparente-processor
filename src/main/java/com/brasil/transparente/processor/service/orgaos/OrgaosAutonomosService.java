...
public class OrgaosAutonomosService {
    ...
    public Poder generateIndependentOrgansBranch(String year) {
        ...
        ministerioPublicoFederalGeneratorService.generateExpenses(poder, StandardCharsets.UTF_8, MINISTERIO_PUBLICO_PATH + MINISTERIO_PUBLICO_TRABALHO + "/" + year + ".csv",2, ";");
        ministerioPublicoFederalGeneratorService.generateExpenses(poder, StandardCharsets.UTF_8, MINISTERIO_PUBLICO_PATH + MINISTERIO_PUBLICO_MILITAR + "/" + year + ".csv",2, ";");
